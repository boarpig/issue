...
def main():
    ...
    new_parser.add_argument("-m", "--message", 
            help="Message for the issue. if omitted, the $EDITOR will be invoked.")

    list_parser = subparsers.add_parser("list", help="List issues")
    list_parser.add_argument("-a", "--all", action="store_true", default=False,
            help="List all issues instead of open ones.")
    list_parser.add_argument("-c", "--closed", action="store_true", default=False,
